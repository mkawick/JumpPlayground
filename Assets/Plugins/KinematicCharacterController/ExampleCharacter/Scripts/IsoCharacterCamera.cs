...
{
    public class IsoCharacterCamera : MonoBehaviour
    {
        [Header("Framing")]
        public Camera Camera;
        public Vector2 FollowPointFraming = new Vector2(0f, 0f);
        public Vector3 FixedRotationFollowing = new Vector3(0f, 0f, 0f);
        ...
        public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
        {
            if (FollowTransform)
            {
                /*if(FixedRotationFollowing.sqrMagnitude != 0)
                {
                    rotationInput.x = FixedRotationFollowing.x;
                    rotationInput.y = FixedRotationFollowing.y;
                }*/
                if (InvertX)
                {
                    rotationInput.x *= -1f;
                ...
                {
                    PlanarDirection = Vector3.Cross(FollowTransform.up, Vector3.Cross(FixedRotationFollowing, FollowTransform.up));
                }
