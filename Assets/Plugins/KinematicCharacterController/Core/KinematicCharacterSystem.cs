...
namespace KinematicCharacterControllerNamespace
{
    ...
    public class KinematicCharacterSystem : MonoBehaviour
    {
        ...
        public static List<KinematicCharacterConfig> CharacterMotors = new List<KinematicCharacterConfig>();
        ...
        /// </summary>
        public static void RegisterCharacterMotor(KinematicCharacterConfig motor)
        {
        ...
        /// </summary>
        public static void UnregisterCharacterMotor(KinematicCharacterConfig motor)
        {
        ...
        public static void PreSimulationInterpolationUpdate(float deltaTime)
        {
            ...
            {
                KinematicCharacterConfig motor = CharacterMotors[i];
        ...
        /// </summary>
        public static void Simulate(float deltaTime, List<KinematicCharacterConfig> motors, List<PhysicsMover> movers)
        {
...
#pragma warning disable 0162
            ...
            for (int i = 0; i < characterMotorsCount; i++)
            {
                KinematicCharacterConfig motor = motors[i];
